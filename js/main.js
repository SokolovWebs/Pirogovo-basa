...
// const imgsBlock = document.querySelector('.imgs_block');

// if (blockDescription && imgsBlock) {
//     const imgsBlockWidth = imgsBlock.offsetWidth;
//     blockDescription.style.width = `${imgsBlockWidth}px`;
// }
